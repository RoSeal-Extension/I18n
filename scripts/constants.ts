...
export { type MessageFormatElement } from "https://esm.sh/v128/@formatjs/icu-messageformat-parser@2.4.0";
export { default as I18n } from "https://esm.sh/v128/intl-messageformat@10.3.5";
